 ...
 * @ingroup Internal
 *
 * If there is a recycled event available, use that.
...
/**
 * @brief Replace the token on the specified event with the specified
...
/**
 * @brief Generated function that produces a table containing all triggers
...
/**
 * @brief Advance from the current tag to the next.
 * @ingroup Internal
 *
 * If the given next_time is equal to
...
/**
 * @brief Invoke the specified reaction on the specified worker in the specified environment.
 * @ingroup Internal
 *
 * @param env The environment in which we are executing.
 * @param reaction The reaction.
 ...
 * @ref _lf_initialize_trigger_objects() function.
 * @ingroup Internal
 */
