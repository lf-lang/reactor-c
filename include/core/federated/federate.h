 ...
 * connection will then be used in functions such as lf_send_tagged_message()
...
/**
 * Send a latest tag complete (LTC) message to the RTI
...
/**
 * Set the trace object for this federate (used when tracing is enabled).
