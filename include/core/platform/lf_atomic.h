...
bool lf_bool_compare_and_swap32(int32_t* ptr, int32_t value, int32_t newval);
bool lf_bool_compare_and_swap64(int64_t* ptr, int64_t value, int64_t newval);
int32_t lf_val_compare_and_swap32(int32_t *ptr, int32_t val, int32_t newval);
