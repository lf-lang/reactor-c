 ...
 * @author Edward A. Lee
 *
 * @brief Standalone program to convert a Lingua Franca trace file to a JSON file suitable
 * for viewing in Chrome's event visualizer.
 *
 * To visualize the resulting file, point your chrome browser to chrome://tracing/ and the load the .json file.
 */
#define LF_TRACE
