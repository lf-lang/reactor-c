...
bool lf_atomic_bool_compare_and_swap(bool *ptr, bool oldval, bool newval) {
    return  (InterlockedCompareExchange(ptr, newval, oldval) == oldval)
}
int  lf_atomic_val32_compare_and_swap(int32_t *ptr, int32_t oldval, int32_t newval) {
    return InterlockedCompareExchange(ptr, newval, oldval)
}
int64_t  lf_atomic_val64_compare_and_swap(int64_t *ptr, int64_t oldval, int64_t newval) {
