...
// Function generated by the C code generator to compute priority from deadline.
...
static void* worker(void* arg) {
  ...
  // Configure thread scheduling policy and CPU affinity if specified
#ifdef LF_THREAD_POLICY
  {
    lf_scheduling_policy_t policy;
    policy.policy = LF_THREAD_POLICY;
    policy.priority = LF_SCHED_MAX_PRIORITY;
    policy.time_slice = 0;
