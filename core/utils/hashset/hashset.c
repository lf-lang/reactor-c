 ...
 * consistently of type void*. Note that the void* value 1 is used to mark a
 * deleted item and therefore cannot be stored in the hashset. Also, used float
 * rather than double for determining whether to rehash.
 */
